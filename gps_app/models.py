...
class Cercado(models.Model):
    ...
    lat1 = models.DecimalField(max_digits=9, decimal_places=6)
    lon1 = models.DecimalField(max_digits=9, decimal_places=6)
    lat2 = models.DecimalField(max_digits=9, decimal_places=6)
    lon2 = models.DecimalField(max_digits=9, decimal_places=6)
    lat3 = models.DecimalField(max_digits=9, decimal_places=6)
    lon3 = models.DecimalField(max_digits=9, decimal_places=6)
    lat4 = models.DecimalField(max_digits=9, decimal_places=6)
    lon4 = models.DecimalField(max_digits=9, decimal_places=6)
